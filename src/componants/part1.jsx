...
function Part1(){
    ...
    // let [tarekh1,tarekh2]=useState(formattedDate)


    let [get1,set1]=useState([])

    // const onKeyDown1=(index)=>{
    //     if (index.key==="Enter"){
    //         if (index.target.value!=""){
    //             let data=index.target.value
    //             index.target.value=""
    //             let newdata=[...lunch1,data]
    //             lunch2(newdata);}
    //     }
    // }
    ...
    <div className={style["maindiv"]}>
        ...
        <h4 className={style["lunch"]}> <img src="break.jpeg" alt="" className={style["img"]}/>Lunch</h4>

        {/* <input type="text" name="" id="" placeholder="Enter Date Here" className={style["input"]}
